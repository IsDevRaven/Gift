...
struct PreguntaView: View {
    ...
    @State private var codigoPremio = ["7K9p3RfG5A", "a2BcD3eFgH", "4rdfs211eq", "pa231cvs", "31sdasfrew"]
    ...
    var fechasDesbloqueo: [FechaDesbloqueo] = [
        ...
        FechaDesbloqueo(year: 2023, month: 10, day: 21, hour: 21),
        FechaDesbloqueo(year: 2023, month: 10, day: 21, hour: 21),
        FechaDesbloqueo(year: 2025, month: 1, day: 1, hour: 0)
    ...
    var body: some View {
        VStack {
            if tiempoRestante > 0 {
                Text(formatDate(fecha:fechaFinal))
